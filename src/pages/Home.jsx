...
export default function Home() {
  return (
    <main className="flex-grow text-gray-800 m-2 mt-4">
      <div className="container max-w-4xl mx-auto p-2 my-6 md:px-6 bg-teal-50 diagonal-stripes rounded-3xl shadow-xl">
                <img
          src="./assets/munamii.png"
          alt="Munamii Cakery Logo"
          className="mx-auto m-4 rounded-full shadow-xl h-56"
        />
        <div className="rounded-2xl p-4 mx-0 shadow-lg border bg-white border-gray-200 pt-4">
          {/*           
